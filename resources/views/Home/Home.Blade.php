					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="header-search">
								<div class="form" >
									<form  action="{{route('Get_Product_Paging')}}">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a  href="{{route('Get_Product_Paging')}}">Xem tất cả Laptop</a></li>
							...
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											<div class="product-img">
												<img src="/assets/Home/img/product04.png" alt="">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">product name goes here</a></h3>
										...
										<div class="product">
											<div class="product-img">
												<img src="/assets/Home/img/product05.png" alt="">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">product name goes here</a></h3>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Xem tất cả Laptop</a></li>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 col-xs-6">
						<div class="section-title">
							<h4 class="title">Mua nhiều nhất</h4>
							<div class="section-nav">
							...
							<div>
                                ...
                                <div class="product-widget">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name"><a href="#">{{Str::limit($item->product_name ,$limit = 25, $end = '...')}}</a></h3>
                                        <h4 class="product-price">{{number_format($item->price)}}<del class="product-old-price">$990.00</del></h4>
                                    </div>
                                </div>
                                <!-- /product widget -->
                                @endforeach
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Đăng nhập để nhận  <strong>Thông tin mới nhất</strong></p>
							<form>
