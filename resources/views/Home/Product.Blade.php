					...
					<div class="row">
						...
						<div class="col-md-3 clearfix">
							<div class="header-ctn">
								...
								<!-- Cart -->
								<div class="dropdown">
									<a class="dropdown-toggle"  aria-expanded="true"href="{{route('ViewCart')}}">
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview">
								<img src="/uploads/Product/{{$products->image_url}}" alt="">
							</div>
							...
							<div class="product-preview">
								<img src="/assets/Home/img/product06.png" alt="">
							</div>

							<div class="product-preview">
								<img src="/assets/Home/img/product08.png" alt="">
							</div>
						</div>
					</div>
					<!-- /Product main img -->
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price"> {{number_format($products->price -$products->price*5/100)}}đ<del class="product-old-price">{{number_format($products->price)}}</del></h3>
							...
							<div class="add-to-cart">
								...
								<a href="{{route('AddToCart').'/'.$products->id}}"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
							</div>
